...
let swappedString = String.fromCharCode(inputString2.charCodeAt(5)) + inputString2[1] + inputString2[2] + inputString2[3] + inputString2[4] + inputString2[5] + String.fromCharCode(inputString2.charCodeAt(0)); // Your code here
